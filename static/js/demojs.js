...
$(document).ready(function(){
	...
	$('.enddemo').live('click', function(ev) {
		ev.preventDefault();
		$('.demo').html("This is the calendar when the user started on March 11. The grey boxes represent the days when he missed the task. Set your calendar as your homepage, so that you're always reminded of your task. That's it. Want to <a href='../signup'>sign up?</a>");
